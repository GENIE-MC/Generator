...
//______________________________________________________________________________
void GuiTableRenderer::DrawXSecTable(DBTable<vXSecTableRow> * table)
{
...
//______________________________________________________________________________
void GuiTableRenderer::DrawXSecTable(DBTable<eDiffXSecTableRow> * table)
{
  SysLogSingleton *  syslog  = SysLogSingleton::Instance();
...
//______________________________________________________________________________
void GuiTableRenderer::DrawXSecTable(DBTable<SFTableRow> * table)
{
  SysLogSingleton *  syslog  = SysLogSingleton::Instance();
...
//______________________________________________________________________________
void GuiTableRenderer::DrawGraphInCanvas(DBTable<vXSecTableRow> * table)
{
...
void GuiTableRenderer::DrawMultiGraphInCanvas(DBTable<vXSecTableRow> * table)
{
  string draw_opt = fErrorOpt + ( (fScaleWithE) ? "-scale-with-E" : "") ;
...
void GuiTableRenderer::DrawGraphInCanvas(
                             genie::nuvld::DBTable<eDiffXSecTableRow> * table)
{
...
//____________________________________________________________________________
void GuiTableRenderer::DrawGraphInCanvas(
                                    genie::nuvld::DBTable<SFTableRow> * table)
{
  TGraphAsymmErrors * graph = table->GetGraph(fDrawOpt.c_str(), fPlotVar.c_str());
