  ...
  public:
     ...
     char * as_string(SqlEnum_t sql) {
       switch(sql) {
         ...
         case kCreateTable_Measurements:          return "create table MEASUREMENTS"; break;
     ...
     char * filename(SqlEnum_t sql) {     
       switch(sql) {
         ...
         case kCreateTable_Measurements:          return "createTable_Measurements.sql"; break;
