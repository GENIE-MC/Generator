...
IntranukeAlt::IntranukeAlt() :
EventRecordVisitorI()
{

}
//___________________________________________________________________________
IntranukeAlt::IntranukeAlt(string name) :
EventRecordVisitorI(name)
{

}
//___________________________________________________________________________
IntranukeAlt::IntranukeAlt(string name, string config) :
...
//___________________________________________________________________________
void IntranukeAlt::ProcessEventRecord(GHepRecord * evrec) const
{
  // Do not continue if there is no nuclear target
  GHepParticle * nucltgt = evrec->TargetNucleus();
  if (!nucltgt) {
    LOG("HNIntranukeAlt", pINFO) << "No nuclear target found - INTRANUKE exits";
    return;
  }
...
//___________________________________________________________________________
void IntranukeAlt::GenerateVertex(GHepRecord * evrec) const
{
...
//___________________________________________________________________________
void IntranukeAlt::SetTrackingRadius(const GHepParticle * p) const
{
...
//___________________________________________________________________________
bool IntranukeAlt::NeedsRescattering(const GHepParticle * p) const
{
...
//___________________________________________________________________________
bool IntranukeAlt::CanRescatter(const GHepParticle * p) const
{
...
//___________________________________________________________________________
bool IntranukeAlt::IsInNucleus(const GHepParticle * p) const
{
...
//___________________________________________________________________________
void IntranukeAlt::TransportHadrons(GHepRecord * evrec) const
{
// transport all hadrons outside the nucleus
  ...
  while( (p = (GHepParticle *) piter.Next()) )
  {
    ...
    // Current snapshot
    //LOG("IntranukeAlt", pINFO) << "Current event record snapshot: " << *evrec;
...
//___________________________________________________________________________
double IntranukeAlt::GenerateStep(GHepRecord* /*evrec*/, GHepParticle* p) const
{
...
// from an exp(-d/L) distribution
  ...
  LOG("IntranukeAlt", pDEBUG)
            << "Mean free path = " << L << " fm / "
                              << "Generated path length = " << d << " fm";
  return d;
}
//___________________________________________________________________________
void IntranukeAlt::Configure(const Registry & config)
{
