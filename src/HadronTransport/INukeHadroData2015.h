...
#ifndef _INTRANUKE_HADRON_CROSS_SECTIONS_2015_H_
#define _INTRANUKE_HADRON_CROSS_SECTIONS_2015_H_
...
private:
  INukeHadroData2015();
  INukeHadroData2015(const INukeHadroData2015 & shx);
 ~INukeHadroData2015();
  ...
  struct Cleaner {
      ...
      ~Cleaner() {
         if (INukeHadroData2015::fInstance !=0) {
            delete INukeHadroData2015::fInstance;
            INukeHadroData2015::fInstance = 0;
         }
      }
  };
