...
#ifndef _INTRANUKE_ALT_H_
#define _INTRANUKE_ALT_H_
...
class PDGCodeList;
class HNIntranukeAlt;
class HAIntranukeAlt;

class IntranukeAlt : public EventRecordVisitorI {

friend class IntranukeTester;

public :
  IntranukeAlt();
  IntranukeAlt(string name);
  IntranukeAlt(string name, string config);
 ~IntranukeAlt();
