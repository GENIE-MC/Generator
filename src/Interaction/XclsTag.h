...
public:
  ...
  XclsTag();
  XclsTag(const XclsTag & final_state);
  virtual ~XclsTag();
...
private:
  ...
  int  fNProtons;     // number of p's in the final state hadronic system
  int  fNNeutrons;    // number of n's in the final state hadronic system
  int  fNPi0;         // number of pi^0's in the final state hadronic system
  int  fNPiPlus;      // number of pi^+'s in the final state hadronic system
  int  fNPiMinus;     // number of pi^-'s in the final state hadronic system
};
