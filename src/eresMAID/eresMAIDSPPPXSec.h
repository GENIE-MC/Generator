...
#ifndef _ERESMAID_SPP_PXSEC_H_
#define _ERESMAID_SPP_PXSEC_H_
...
class eresMAIDSPPPXSec : public XSecAlgorithmI {

public:
  eresMAIDSPPPXSec();
  eresMAIDSPPPXSec(string config);
  virtual ~eresMAIDSPPPXSec();
