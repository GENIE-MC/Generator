...
\class    genie::eresMAIDRESXSecWithCache
...
class eresMAIDRESXSecWithCache : public XSecIntegratorI {

protected:
  eresMAIDRESXSecWithCache();
  eresMAIDRESXSecWithCache(string name);
  eresMAIDRESXSecWithCache(string name, string config);
  virtual ~eresMAIDRESXSecWithCache();
