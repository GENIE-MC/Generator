...
//____________________________________________________________________________
eresMAIDRESXSecWithCache::eresMAIDRESXSecWithCache() :
XSecIntegratorI()
{

}
//____________________________________________________________________________
eresMAIDRESXSecWithCache::eresMAIDRESXSecWithCache(string nm) :
XSecIntegratorI(nm)
{

}
//____________________________________________________________________________
eresMAIDRESXSecWithCache::eresMAIDRESXSecWithCache(string nm,string conf):
...
//____________________________________________________________________________
void eresMAIDRESXSecWithCache::CacheResExcitationXSec(
...
//  assert(fIntegrator);
  ...
  for(unsigned int ires = 0; ires < nres; ires++) {
         ...
         LOG("eresMAIDResC", pNOTICE) << "E threshold = " << Ethr;
...
//____________________________________________________________________________
string eresMAIDRESXSecWithCache::CacheBranchName(
