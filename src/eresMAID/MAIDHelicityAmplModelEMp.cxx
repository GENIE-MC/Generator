...
#include "eresMAID/MAIDHelicityAmplModelEMp.h"
...
const MAIDHelicityAmpl & 
    MAIDHelicityAmplModelEMp::Compute(
          Resonance_t res, const FKR & fkr, const Interaction * interaction) const
{
  ...
  switch(res) {
   ...
   case (kP33_1232) :
   {
     ...
     fAmpl.fMinus1 =  TMath::Sqrt((Mnuc/MR)*(Mnuc/MR)*kgcm0/(2.*kPi*kAem))*A12;
     fAmpl.fPlus1  = -fAmpl.fMinus1;
     fAmpl.fMinus3 =  TMath::Sqrt((Mnuc/MR)*(Mnuc/MR)*kgcm0/(2.*kPi*kAem))*A32;
     fAmpl.fPlus3  = -fAmpl.fMinus3;
     fAmpl.f0Minus =  TMath::Sqrt((Mnuc/MR)*(Mnuc*MR)*kgcm0/(2.*kPi*kAem))*(-q2/(qvec*qvec))*S12;
   ...
   case (kD15_1675) :
   {
     ...
     fAmpl.fMinus1 =  TMath::Sqrt((Mnuc/MR)*(Mnuc/MR)*kgcm0/(2.*kPi*kAem))*A12;
     fAmpl.fPlus1  = -fAmpl.fMinus1;
     fAmpl.fMinus3 =  TMath::Sqrt((Mnuc/MR)*(Mnuc/MR)*kR/(2.*kPi*kAem))*A32;
     fAmpl.fPlus3  = -fAmpl.fMinus3;
     fAmpl.f0Minus =  TMath::Sqrt((Mnuc/MR)*(Mnuc/MR)*kR/(2.*kPi*kAem))*(-q2/(qvec*qvec))*S12;
     fAmpl.f0Plus  = fAmpl.f0Minus;
