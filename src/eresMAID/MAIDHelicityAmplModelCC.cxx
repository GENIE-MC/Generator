...
#include "eresMAID/MAIDHelicityAmplModelCC.h"
...
//____________________________________________________________________________
MAIDHelicityAmplModelCC::MAIDHelicityAmplModelCC() :
MAIDHelicityAmplModelI("genie::MAIDHelicityAmplModelCC")
{

}
//____________________________________________________________________________
MAIDHelicityAmplModelCC::MAIDHelicityAmplModelCC(string config) :
MAIDHelicityAmplModelI("genie::MAIDHelicityAmplModelCC", config)
{
...
const MAIDHelicityAmpl & 
  MAIDHelicityAmplModelCC::Compute(
