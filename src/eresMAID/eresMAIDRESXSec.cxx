...
#include "eresMAID/eresMAIDRESXSec.h"
...
//____________________________________________________________________________
eresMAIDRESXSec::eresMAIDRESXSec() :
eresMAIDRESXSecWithCache("genie::eresMAIDRESXSec")
{

}
//____________________________________________________________________________
eresMAIDRESXSec::eresMAIDRESXSec(string config) :
eresMAIDRESXSecWithCache("genie::eresMAIDRESXSec", config)
{
...
//____________________________________________________________________________
double eresMAIDRESXSec::Integrate(
          const XSecAlgorithmI * model, const Interaction * interaction) const
{
  ...
  if(!kps.IsAboveThreshold()) {
     LOG("eresMAIDRESXSec", pDEBUG)  << "*** Below energy threshold";
     return 0;
  }
  ...
  if(bare_xsec_pre_calc) {
     ...
     if(!cache_branch) {
        ...
        LOG("eresMAIDResT", pINFO) << "Done caching resonance xsec data";
        LOG("eresMAIDResT", pINFO) 
...
//____________________________________________________________________________
void eresMAIDRESXSec::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void eresMAIDRESXSec::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void eresMAIDRESXSec::LoadConfig(void)
{
