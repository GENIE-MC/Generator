...
/*
 ...
 @ Oct 05, 2009 - CA
   Compute() now returns a `const MAIDHelicityAmpl &' and avoids creating a new
   MAIDHelicityAmpl at each call.                      
...
#include "eresMAID/MAIDHelicityAmplModelNCn.h"
...
//____________________________________________________________________________
MAIDHelicityAmplModelNCn::MAIDHelicityAmplModelNCn() :
MAIDHelicityAmplModelI("genie::MAIDHelicityAmplModelNCn")
{

}
//____________________________________________________________________________
MAIDHelicityAmplModelNCn::MAIDHelicityAmplModelNCn(string config) :
MAIDHelicityAmplModelI("genie::MAIDHelicityAmplModelNCn", config)
{
...
const MAIDHelicityAmpl & 
  MAIDHelicityAmplModelNCn::Compute(
...
//____________________________________________________________________________
void MAIDHelicityAmplModelNCn::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void MAIDHelicityAmplModelNCn::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void MAIDHelicityAmplModelNCn::LoadConfig(void)
{
