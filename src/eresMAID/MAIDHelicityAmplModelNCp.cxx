...
#include "eresMAID/MAIDHelicityAmplModelNCp.h"
...
//____________________________________________________________________________
MAIDHelicityAmplModelNCp::MAIDHelicityAmplModelNCp() :
MAIDHelicityAmplModelI("genie::MAIDHelicityAmplModelNCp")
{

}
//____________________________________________________________________________
MAIDHelicityAmplModelNCp::MAIDHelicityAmplModelNCp(string config) :
MAIDHelicityAmplModelI("genie::MAIDHelicityAmplModelNCp", config)
{
...
const MAIDHelicityAmpl & 
   MAIDHelicityAmplModelNCp::Compute(
...
//____________________________________________________________________________
void MAIDHelicityAmplModelNCp::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void MAIDHelicityAmplModelNCp::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void MAIDHelicityAmplModelNCp::LoadConfig(void)
{
