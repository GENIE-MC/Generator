...
public:
 ...
 ~Interaction();
  ...
  static Interaction * COHCC     (int tgt, int probe, unsigned int other_pdg, double E=0);
  static Interaction * COHCC     (int tgt, int probe, unsigned int other_pdg, 
				  const TLorentzVector & p4probe);
  static Interaction * COHNC     (int tgt, int probe, unsigned int other_pdg, double E=0);
  static Interaction * COHNC     (int tgt, int probe, unsigned int other_pdg, 
				  const TLorentzVector & p4probe);
