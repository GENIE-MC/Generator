...
namespace kinematics
{
  ...
  Range1D_t  CohW2Lim    (double Mn, double m_other, double mlep, double Ev, double Q2);
  Range1D_t  CohNuLim    (double W2min, double W2max, double Q2, double Mn, double xsi);
  Range1D_t  CohYLim     (double Mn, double m_other, double mlep, double Ev, double Q2, double xsi);
  Range1D_t  CohYLim     (double EvL, double ml);
  Range1D_t  CohXLim     (void);
  Range1D_t  CohQ2Lim    (double Mn, double m_other, double mlep, double Ev);
  Range1D_t  Cohq2Lim    (double Mn, double m_other, double mlep, double Ev);
  ...
  double CohW2Min(double Mn, double m_other);
