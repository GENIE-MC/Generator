...
void test_parallel_orthogonal_genie() {
    ...
    auto parallel1 = GetParallel(lv1, unitVec);
    auto orthogonal1 = GetOrthogonal(lv1, unitVec);
    ...
    auto parallel2 = GetParallel(lv2, unitVec);
    auto orthogonal2 = GetOrthogonal(lv2, unitVec);
    ...
    auto parallel3 = GetParallel(lv3, unitVec);
    auto orthogonal3 = GetOrthogonal(lv3, unitVec);
