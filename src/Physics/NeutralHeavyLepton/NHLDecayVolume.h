...
\class     genie::NHL::NHLDecayVolume
...
namespace NHL {
  ...
  class NHLDecayVolume : public EventRecordVisitorI {

  public:

    NHLDecayVolume();
    NHLDecayVolume(string config);
    ~NHLDecayVolume();
    ...
    void SetStartingParameters( GHepRecord * event_rec, double NHLCoMTau, bool usingDk2nu, bool usingRootGeom, string geomfile ) const;
  ...
  private:
    ...
    mutable double fCoMLifetime = 0.0; // NHL lifetime in ns
