...
//____________________________________________________________________________
DISStructureFunc::DISStructureFunc() { this->Reset(); }
//____________________________________________________________________________
...
bool DISStructureFunc::Compare(const DISStructureFunc &sf) const {
  bool equal =
      math::AreEqual(this->fF1, sf.fF1) && math::AreEqual(this->fF2, sf.fF2) &&
      math::AreEqual(this->fF3, sf.fF3) && math::AreEqual(this->fF4, sf.fF4) &&
      math::AreEqual(this->fF5, sf.fF5) && math::AreEqual(this->fF6, sf.fF6);
  return equal;
}
//____________________________________________________________________________
void DISStructureFunc::Print(ostream &stream) const {
  stream << "(F1-F6) = (" << this->fF1 << ", " << this->fF2 << ", " << this->fF3
         << ", " << this->fF4 << ", " << this->fF5 << ", " << this->fF6 << ")"
         << endl;
  /*
