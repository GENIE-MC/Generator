...
//____________________________________________________________________________
BY00StrucFunc::BY00StrucFunc() : QPMDISStrucFuncBase("genie::BY00StrucFunc") {
  this->Init();
}
//____________________________________________________________________________
...
void BY00StrucFunc::KVectorFactors(const Interaction *interaction, double &kuv,
  ...
  // Overrides QPMDISStrucFuncBase::KVectorFactors() to compute the BY K factors
  // for u(valence), d(valence), u(sea), d(sea); In this version, Vector
  // K-Factors are used for the axial component
...
//____________________________________________________________________________
void BY00StrucFunc::KAxialFactors(const Interaction *interaction, double &kuv,
                                  double &kdv, double &kus, double &kds,
                                  double &kss) const {
