...
//____________________________________________________________________________
QPMDISPXSec::QPMDISPXSec() : XSecAlgorithmI("genie::QPMDISPXSec") {
  fInInitPhase = true;
}
//____________________________________________________________________________
...
//____________________________________________________________________________
double QPMDISPXSec::XSec(const Interaction *interaction,
  ...
  LOG("DISPXSec", pDEBUG) << "Computing d2xsec/dxdy @ E = " << E
                          << ", x = " << x << ", y = " << y;
#endif
