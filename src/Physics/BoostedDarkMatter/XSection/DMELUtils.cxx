...
double genie::utils::EnergyDeltaFunctionSolutionDMEL(
...
double genie::utils::ComputeFullDMELPXSec(genie::Interaction* interaction,
  ...
  genie::DMELEvGen_BindingMode_t hitNucleonBindingMode, double min_angle_EM,
  bool bind_nucleon)
{
...
genie::DMELEvGen_BindingMode_t genie::utils::StringToDMELBindingMode(
