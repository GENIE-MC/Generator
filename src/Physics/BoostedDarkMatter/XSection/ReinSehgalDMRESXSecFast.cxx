...
#include "Physics/BoostedDarkMatter/XSection/ReinSehgalDMRESXSecFast.h"
...
//____________________________________________________________________________
ReinSehgalDMRESXSecFast::ReinSehgalDMRESXSecFast() :
ReinSehgalDMRESXSecWithCacheFast("genie::ReinSehgalDMRESXSecFast")
{

}
//____________________________________________________________________________
ReinSehgalDMRESXSecFast::ReinSehgalDMRESXSecFast(string config) :
ReinSehgalDMRESXSecWithCacheFast("genie::ReinSehgalDMRESXSecFast", config)
{
...
//____________________________________________________________________________
double ReinSehgalDMRESXSecFast::Integrate(
          const XSecAlgorithmI * model, const Interaction * interaction) const
{
  ...
  if(!kps.IsAboveThreshold()) {
     LOG("ReinSehgalDMRESXSecFast", pDEBUG)  << "*** Below energy threshold";
     return 0;
  }
  ...
  // specified interaction.  
    ...
    LOG("ReinSehgalResTF", pINFO) << "About to crate a new integration...";
    ROOT::Math::IBaseFunctionMultiDim * func= new utils::gsl::d2XSecDMRESFast_dWQ2_E(model, interaction);
...
//____________________________________________________________________________
void ReinSehgalDMRESXSecFast::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void ReinSehgalDMRESXSecFast::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void ReinSehgalDMRESXSecFast::LoadConfig(void)
{
