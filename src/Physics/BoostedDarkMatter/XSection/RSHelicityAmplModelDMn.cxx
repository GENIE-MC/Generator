...
RSHelicityAmplModelI("genie::RSHelicityAmplModelDMn")
{

}
//____________________________________________________________________________
RSHelicityAmplModelDMn::RSHelicityAmplModelDMn(string config) :
RSHelicityAmplModelI("genie::RSHelicityAmplModelDMn", config)
{
      ...
      Resonance_t res, const FKR & fkr) const
{
  switch(res) {
   ...
   case (kS11_1535) :
   {
     ...
     double RVQV5ud = fkr.Rv * (fQVu + 5 * fQVd);
     double RAQA5ud = fkr.Ra * (fQAu + 5 * fQAd);
     double QA5ud = fQAu + 5 * fQAd;
   ...
   case (kD13_1520) :
   {
     ...
     fAmpl.fMinus3 =  3 * k1_Sqrt2 * ( TAQAud + TVQVud);
     fAmpl.fPlus3  =  3 * k1_Sqrt2 * (-TAQAud + TVQVud);
     fAmpl.f0Minus =  a + b;
     fAmpl.f0Plus  =  a - b;
     break;
   }
   case (kS11_1650) :
   {
     double LRVQVu2d = fkr.Rv * (2 * fQAu + fQAd) * fkr.Lamda;
     double LRAQAu2d = fkr.Ra * (2 * fQAu + fQAd) * fkr.Lamda;
     
     fAmpl.fMinus1 =  ( LRVQVu2d + LRAQAu2d) / kSqrt6;
     fAmpl.fPlus1  =  (-LRVQVu2d + LRAQAu2d) / kSqrt6;
     fAmpl.fMinus3 =  0.;
     fAmpl.fPlus3  =  0.;
     fAmpl.f0Minus =  kSqrt2_3 * (fQAd + 2 * fQAu) * (3 * fkr.B - fkr.Lamda * fkr.C);
     fAmpl.f0Plus  =  fAmpl.f0Minus;
     break;
   }
   case (kD13_1700) :
   {
     ...
     fAmpl.f0Minus =  kSqrt2_15 * fkr.Lamda * fkr.C * (2 * fQAu + fQAd);
     fAmpl.f0Plus  =  -1.* fAmpl.f0Minus;
     break;
   }
   case (kD15_1675) :
   {
     double LRm     = fkr.Lamda * ((fQAd + 2 * fQAu) * fkr.Ra + (fQVd + 2 * fQVu) * fkr.Rv);
     double LRp     = fkr.Lamda * ((fQAd + 2 * fQAu) * fkr.Ra - (fQVd + 2 * fQVu) * fkr.Rv);

     fAmpl.fMinus1 = -kSqrt3_10 * LRm;
     fAmpl.fPlus1  = -kSqrt3_10 * LRp;
     fAmpl.fMinus3 = -kSqrt3_5  * LRm;
     fAmpl.fPlus3  = -kSqrt3_5  * LRp;
     fAmpl.f0Minus =  kSqrt6_5 * fkr.Lamda * fkr.C * (fQAd + 2 * fQAu);
     fAmpl.f0Plus  =  fAmpl.f0Minus;
     break;
   }
   case (kS31_1620) :
   ...
   case (kP11_1440) :
   {
     ...
     double L2RmxiR = L2 * ((4 * fQVd - fQVu) * fkr.Rv + (4 * fQAd - fQAu) * fkr.Ra);
     double L2RpxiR = L2 * ((4 * fQVd - fQVu) * fkr.Rv - (4 * fQAd - fQAu) * fkr.Ra);
     double a       = 3 * c * L2 * fkr.S * (fQVu + 2 * fQVd);
     double b       = c * (L2 * fkr.C - 2 * fkr.Lamda * fkr.B) * (4 * fQAd - fQAu);
   ...
   {
     double L2      = TMath::Power(fkr.Lamda, 2);
     double LTm4xiT = fkr.Lamda * ( fkr.Tv * (2 * fQVd + fQVu) + fkr.Ta * (2 * fQAd + fQAu));
     double LTp4xiT = fkr.Lamda * (-fkr.Tv * (2 * fQVd + fQVu) + fkr.Ta * (2 * fQAd + fQAu));
     double L2RmxiR = L2        * ( fkr.Rv * (4 * fQVd - fQVu) + fkr.Ra * (4 * fQAd + fQAu));
     double L2RpxiR = L2        * (-fkr.Rv * (4 * fQVd - fQVu) + fkr.Ra * (4 * fQAd + fQAu));
     double a       = kSqrt3_5 * L2 * fkr.S * (2 * fQVd + fQVu);
     double b       = k1_Sqrt15 * (L2 * fkr.C - 5 * fkr.Lamda * fkr.B) * (4 * fQAd - fQAu);
   ...
   case (kF15_1680) :
   {
     ...
     double L2RmxiR = L2 * (fkr.Rv * (4 * fQVd - fQVu) + fkr.Ra * (4 * fQAd - fQAu));
     double L2RpxiR = L2 * (fkr.Rv * (4 * fQVd - fQVu) - fkr.Ra * (4 * fQAd - fQAu));
     double a       = k3_Sqrt10 * L2 * fkr.S * (2 * fQVd + fQVu);
     double b       = k1_Sqrt10 * L2 * fkr.C * (4 * fQAd - fQAu);
   ...
   {
     double L2      = TMath::Power(fkr.Lamda, 2);
     double Rm3xiR  = fkr.Rv * (5 * fQVd + fQVu) + fkr.Ra * (5 * fQAd + fQAu);
     double Rp3xiR  = fkr.Rv * (5 * fQVd + fQVu) - fkr.Ra * (5 * fQAd + fQAu);
     double a       = kSqrt3_8 * L2 * fkr.S * (fQVu - fQVd);
     double b       = 0.5 * k1_Sqrt6 * (L2 * fkr.C - 2 * fkr.Lamda * fkr.B) * (5 * fQAd + fQAu);
   ...
   {
     double L2      = TMath::Power(fkr.Lamda, 2);
     double Rm3xiR  = fkr.Rv * (fQVd + 2 * fQVu) + fkr.Ra * (fQAd + 2 * fQAu);
     double Rp3xiR  = fkr.Rv * (fQVd + 2 * fQVu) - fkr.Ra * (fQAd + 2 * fQAu);
     ...
     fAmpl.f0Minus =  kSqrt6_35 * L2 * fkr.C * (fQAd + 2 * fQAu);
     fAmpl.f0Plus  =  fAmpl.f0Minus;
     break;
   }
   default:
...
//____________________________________________________________________________
void RSHelicityAmplModelDMn::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void RSHelicityAmplModelDMn::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void RSHelicityAmplModelDMn::LoadConfig(void)
{
