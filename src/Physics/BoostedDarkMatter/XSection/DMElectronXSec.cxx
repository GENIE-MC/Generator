...
#include "Physics/BoostedDarkMatter/XSection/DMElectronXSec.h"
...
//____________________________________________________________________________
DMElectronXSec::DMElectronXSec() :
XSecIntegratorI("genie::DMElectronXSec")
{

}
//____________________________________________________________________________
DMElectronXSec::DMElectronXSec(string config) :
XSecIntegratorI("genie::DMElectronXSec", config)
{
...
//____________________________________________________________________________
double DMElectronXSec::Integrate(
                 const XSecAlgorithmI * model, const Interaction * in) const
{
  ...
  //LOG("DMEXSec", pDEBUG) << "*** XSec[ve-] (E=" << E << ") = " << xsec;
...
//____________________________________________________________________________
void DMElectronXSec::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void DMElectronXSec::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void DMElectronXSec::LoadConfig(void)
{
