                 ...
                 const Interaction * interaction, KinePhaseSpace_t kps) const
{
  ...
  //std::cout<<"Modified Ev : "<<Ev<<std::endl;
  //std::cout<<"Unmodified Ev : "<<init_state.ProbeE(kRfLab)<<std::endl;
...
//____________________________________________________________________________
double NuElectronPXSec::Integral(const Interaction * interaction, const int N = 2000) const
{
  //subalgorithm: 
  //electron velocity need to generate velocity for integrator and event generator
  //integrator needs to call electron mover
  //decouple generation of dist. from changes in ev rec
  //input of distribution is interaction
  //extract summary (interaction) from evrec
  //integrate -> call this function only
  //set interaction with velocity generated by event generator

  //decouple physics from changes in data model
  //uml: unified modeling language, interfaces classes
  ...
  //const int N = 2000; //Number of random samples 
...
void NuElectronPXSec::LoadConfig(void)
{
  ...
  fElectronVelocity =
      dynamic_cast<const ElectronVelocity *> (this->SubAlg("Bohr-Velocity"));
