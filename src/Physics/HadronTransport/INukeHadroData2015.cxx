...
//____________________________________________________________________________
INukeHadroData2015 * INukeHadroData2015::fInstance = 0;
//____________________________________________________________________________
double INukeHadroData2015::fMinKinEnergy   =    1.0; // MeV
double INukeHadroData2015::fMaxKinEnergyHA =  999.0; // MeV
double INukeHadroData2015::fMaxKinEnergyHN = 1799.0; // MeV
//____________________________________________________________________________
INukeHadroData2015::INukeHadroData2015()
{
...
//____________________________________________________________________________
INukeHadroData2015 * INukeHadroData2015::Instance()
{
  if(fInstance == 0) {
    LOG("INukeData", pINFO) << "INukeHadroData2015 late initialization";
    static INukeHadroData2015::Cleaner cleaner;
    cleaner.DummyMethodAndSilentCompiler();
    fInstance = new INukeHadroData2015;
  }
  return fInstance;
}
//____________________________________________________________________________
void INukeHadroData2015::LoadCrossSections(void)
{
...
//----------------------------------------------------------------------------------------
  ...
  if (saveTGraphsToFile) {
    ...
    LOG("INukeHadroData2015", pNOTICE) << "Saving INTRANUKE hadron x-section data to ROOT file: " << filename;
...
//____________________________________________________________________________
void INukeHadroData2015::ReadhNFile(
...
//____________________________________________________________________________
double INukeHadroData2015::XSec(
...
//____________________________________________________________________________
double INukeHadroData2015::FracADep(int hpdgc, INukeFateHA_t fate, double ke, int targA) const
{
...
//____________________________________________________________________________
double INukeHadroData2015::FracAIndep(int hpdgc, INukeFateHA_t fate, double ke) const
{
// return the x-section fraction for the input fate for the particle with the input pdg 
...
//____________________________________________________________________________
double INukeHadroData2015::XSec(int hpdgc, INukeFateHN_t fate, double ke, int targA, int targZ) const
{
...
double INukeHadroData2015::Frac(int hpdgc, INukeFateHN_t fate, double ke, int targA, int targZ) const
{
...
//____________________________________________________________________________
double INukeHadroData2015::IntBounce(const GHepParticle* p, int target, int scode, INukeFateHN_t fate)
{
