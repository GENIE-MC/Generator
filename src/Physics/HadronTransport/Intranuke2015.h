...
#ifndef _INTRANUKE_2015_H_
#define _INTRANUKE_2015_H_
...
class PDGCodeList;
class HNIntranuke2015;
class HAIntranuke2015;

class Intranuke2015 : public EventRecordVisitorI {
...
protected:
  ...
  INukeHadroData2015 *       fHadroData2015;     ///< a collection of h+N,h+A data & calculations
