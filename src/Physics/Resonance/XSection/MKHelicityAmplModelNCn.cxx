...
#include "Physics/Resonance/XSection/MKHelicityAmplModelNCn.h"

using namespace genie;
using namespace genie::constants;

//____________________________________________________________________________
MKHelicityAmplModelNCn::MKHelicityAmplModelNCn() :
MKHelicityAmplModelI("genie::MKHelicityAmplModelNCn")
{

}
//____________________________________________________________________________
MKHelicityAmplModelNCn::MKHelicityAmplModelNCn(string config) :
MKHelicityAmplModelI("genie::MKHelicityAmplModelNCn", config)
{
...
//____________________________________________________________________________
const MKHelicityAmpl & MKHelicityAmplModelNCn::Compute(Resonance_t res, const FKR_MK & fkr) const
{
  switch(res) {
   ...
   {
     fAmpl.fVMinus3    = 0.;
     fAmpl.fVMinus1    =-kSqrt3*fkr.Tv*(-1. + 2.*fSin28w) - kSqrt2_3*fkr.Lamda*fkr.Rv*(-1. + fSin28w);
     fAmpl.fVPlus1     =-fAmpl.fVMinus1;
     fAmpl.fVPlus3     = 0.;
   ...
   case (kD13_1520) :
   {
     fAmpl.fVMinus3    =-3./kSqrt2*fkr.Tv*(-1. + 2.*fSin28w);
     fAmpl.fVMinus1    =-kSqrt3_2*fkr.Tv*(-1. + 2.*fSin28w) + 2./kSqrt3*fkr.Lamda*fkr.Rv*(-1. + fSin28w);
     fAmpl.fVPlus1     = fAmpl.fVMinus1;
     fAmpl.fVPlus3     = fAmpl.fVMinus3;
     ...
     fAmpl.fAMinus3    = 3./kSqrt2*fkr.Ta;
   ...
   {
     fAmpl.fVMinus3    = 0.;
     fAmpl.fVMinus1    =-k1_Sqrt24*fkr.Lamda*fkr.Rv*(-1. + 4.*fSin28w);
     fAmpl.fVPlus1     =-fAmpl.fVMinus1;
     fAmpl.fVPlus3     = 0.;
     fAmpl.fV0LPlus    = 0.;
     fAmpl.fV0LMinus   = 0.;
   ...
   case (kD13_1700) :
   {
     fAmpl.fVMinus3    =-k3_Sqrt40*fkr.Lamda*fkr.Rv*(-1. + 4.*fSin28w);
     fAmpl.fVMinus1    =-k1_Sqrt120*fkr.Lamda*fkr.Rv*(-1. + 4.*fSin28w);
     fAmpl.fVPlus1     = fAmpl.fVMinus1;
     fAmpl.fVPlus3     = fAmpl.fVMinus3;
     fAmpl.fV0LPlus    = 0.;
     fAmpl.fV0LMinus   = 0.;
   ...
   case (kD15_1675) :
   {
     fAmpl.fVMinus3    = kSqrt3_20*fkr.Lamda*fkr.Rv*(-1. + 4.*fSin28w);
     fAmpl.fVMinus1    = kSqrt3_40*fkr.Lamda*fkr.Rv*(-1. + 4.*fSin28w);
     fAmpl.fVPlus1     =-fAmpl.fVMinus1;
     fAmpl.fVPlus3     =-fAmpl.fVMinus3;
     fAmpl.fV0LPlus    = 0.;
     fAmpl.fV0LMinus   = 0.;
   ...
   {
     fAmpl.fVMinus3    = 0.;
     fAmpl.fVMinus1    = kSqrt3*fkr.Lamda*fkr.Lamda*fkr.Rv*(-5./12 + 2./3.*fSin28w);
     fAmpl.fVPlus1     = fAmpl.fVMinus1;
     fAmpl.fVPlus3     = 0.;
     fAmpl.fV0LPlus    = kSqrt3/4.*fkr.Lamda*fkr.Lamda*fkr.Sminus;
     fAmpl.fV0LMinus   = fAmpl.fV0LPlus;
     fAmpl.fV0RPlus    = 0.;
     fAmpl.fV0RMinus   = 0.;
   ...
   case (kP13_1720) :
   {     
     fAmpl.fVMinus3    = k3_Sqrt40*fkr.Lamda*fkr.Tv;
     fAmpl.fVMinus1    =-kSqrt27_40*fkr.Lamda*fkr.Tv + kSqrt5_12*fkr.Lamda*fkr.Lamda*fkr.Rv*(-1. + 8./5.*fSin28w);
     fAmpl.fVPlus1     =-fAmpl.fVMinus1; 
     fAmpl.fVPlus3     =-fAmpl.fVMinus3;
     fAmpl.fV0LPlus    = kSqrt3_20*fkr.Lamda*fkr.Lamda*fkr.Sminus;
     fAmpl.fV0LMinus   =-fAmpl.fV0LPlus;
     fAmpl.fV0RPlus    = 0.;
     fAmpl.fV0RMinus   = 0.;
   ...
   case (kF15_1680) :
   {
     fAmpl.fVMinus3   =-kSqrt18_20*fkr.Lamda*fkr.Tv;
     fAmpl.fVMinus1   =-k3_Sqrt20*fkr.Lamda*fkr.Tv - kSqrt5_8*fkr.Lamda*fkr.Lamda*fkr.Rv*(-1. + 8./5.*fSin28w);
     fAmpl.fVPlus1    = fAmpl.fVMinus1; 
     fAmpl.fVPlus3    = fAmpl.fVMinus3;
     fAmpl.fV0LPlus   =-k3_Sqrt40*fkr.Lamda*fkr.Lamda*fkr.Sminus;
     fAmpl.fV0LMinus  = fAmpl.fV0LPlus;
     fAmpl.fV0RPlus   = 0.;
     fAmpl.fV0RMinus  = 0.;
   ...
   {
     fAmpl.fVMinus3   = 0.;
     fAmpl.fVMinus1   =-k1_Sqrt6*fkr.Lamda*fkr.Lamda*fkr.Rv*(-1. + fSin28w);
     fAmpl.fVPlus1    = fAmpl.fVMinus1;
     fAmpl.fVPlus3    = 0.;
   ...
   case (kF17_1970) :
   {
     fAmpl.fVMinus3   = k1_Sqrt7/2*fkr.Lamda*fkr.Lamda*fkr.Rv*(-1. + 4*fSin28w);
     fAmpl.fVMinus1   = kSqrt3_35/2*fkr.Lamda*fkr.Lamda*fkr.Rv*(-1. + 4*fSin28w);
     fAmpl.fVPlus1    =-fAmpl.fVMinus1;
     fAmpl.fVPlus3    =-fAmpl.fVMinus3;
     fAmpl.fV0LPlus   = 0.;
     fAmpl.fV0LMinus  = 0.;
...
//____________________________________________________________________________
void MKHelicityAmplModelNCn::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void MKHelicityAmplModelNCn::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void MKHelicityAmplModelNCn::LoadConfig(void)
{
  double thw;
