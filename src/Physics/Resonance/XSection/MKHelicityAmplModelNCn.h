...
\class    genie::MKHelicityAmplModelNCn

\brief    The Helicity Amplitudes, for all baryon resonances, for NC neutrino
          interactions on free neutrons, modified for MK-model.
...
#ifndef _HELICITY_AMPL_MODEL_MK_NC_N_H_
#define _HELICITY_AMPL_MODEL_MK_NC_N_H_

#include "Physics/Resonance/XSection/MKHelicityAmplModelI.h"

namespace genie {

class MKHelicityAmplModelNCn : public MKHelicityAmplModelI {

public:
  MKHelicityAmplModelNCn();
  MKHelicityAmplModelNCn(string config);
  virtual ~MKHelicityAmplModelNCn();
...
#endif   // _HELICITY_AMPL_MODEL_MK_NC_N_H_
