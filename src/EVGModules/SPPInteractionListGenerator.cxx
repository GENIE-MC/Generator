...
#include "EVGModules/SPPInteractionListGenerator.h"
...
SPPInteractionListGenerator::SPPInteractionListGenerator() :
InteractionListGeneratorI("genie::SPPInteractionListGenerator")
{

}
//___________________________________________________________________________
SPPInteractionListGenerator::SPPInteractionListGenerator(string config) :
InteractionListGeneratorI("genie::SPPInteractionListGenerator", config)
{
...
//___________________________________________________________________________
InteractionList * SPPInteractionListGenerator::CreateInteractionList(
...
//___________________________________________________________________________
void SPPInteractionListGenerator::AddFinalStateInfo(
...
//___________________________________________________________________________
void SPPInteractionListGenerator::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfigData();
}
//____________________________________________________________________________
void SPPInteractionListGenerator::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfigData();
}
//____________________________________________________________________________
void SPPInteractionListGenerator::LoadConfigData(void)
{
