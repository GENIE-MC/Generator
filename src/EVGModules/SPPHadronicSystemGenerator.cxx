...
#include "EVGModules/SPPHadronicSystemGenerator.h"
...
SPPHadronicSystemGenerator::SPPHadronicSystemGenerator() :
HadronicSystemGenerator("genie::SPPHadronicSystemGenerator")
{

}
//___________________________________________________________________________
SPPHadronicSystemGenerator::SPPHadronicSystemGenerator(string config):
HadronicSystemGenerator("genie::SPPHadronicSystemGenerator", config)
{
...
//___________________________________________________________________________
void SPPHadronicSystemGenerator::ProcessEventRecord(GHepRecord * evrec) const
{
...
//___________________________________________________________________________
void SPPHadronicSystemGenerator::AddResonanceDecayProducts(
