...
#include "EVGModules/SPPResonanceSelector.h"
...
SPPResonanceSelector::SPPResonanceSelector() :
HadronicSystemGenerator("genie::SPPResonanceSelector")
{

}
//___________________________________________________________________________
SPPResonanceSelector::SPPResonanceSelector(string config) :
HadronicSystemGenerator("genie::SPPResonanceSelector", config)
{
...
//___________________________________________________________________________
void SPPResonanceSelector::ProcessEventRecord(GHepRecord * evrec) const
{
...
//___________________________________________________________________________
Resonance_t SPPResonanceSelector::SelectResonance(GHepRecord * evrec) const
{
...
//___________________________________________________________________________
void SPPResonanceSelector::AddResonance(GHepRecord * evrec) const
{
...
//___________________________________________________________________________
void SPPResonanceSelector::Configure(const Registry & config)
{
...
//____________________________________________________________________________
void SPPResonanceSelector::Configure(string param_set)
{
...
//____________________________________________________________________________
void SPPResonanceSelector::LoadConfigData(void)
{
...
//____________________________________________________________________________
void SPPResonanceSelector::LoadSubAlg(void)
{
  fXSecAlg = 0;
