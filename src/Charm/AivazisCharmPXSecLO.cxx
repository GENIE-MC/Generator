...
double AivazisCharmPXSecLO::XSec(const Interaction * interaction) const
{
  ...
  double tmp = Gw2 * (y*Q2/kPi) * ( pow((1+coshpsi)/2, 2) + 
  ...
  if(d_contributes) xsec += xsec_d;
  if(s_contributes) xsec += xsec_s;
