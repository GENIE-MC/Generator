...
op.add_option("--E-nu-maxsplines", dest="NuEMAXSPINE", type="int", default=100, help="Maximum energy for the splines in GeV. Default: %default ")
...
op.add_option("--job-lifetime", dest="JOBLIFE", default=15, help="Expected lifetime on the grid for all the jobs to be finished, default %default h")
op.add_option("--job-lifetime-vN", dest="vNJOBLIFE", default=8, help="Expected lifetime on the grid for all the vN spline jobs to be finished, default %default h")
