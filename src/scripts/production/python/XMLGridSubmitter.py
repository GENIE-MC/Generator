...
op.add_option("--job-lifetime", dest="JOBLIFE", default=10, help="Expected lifetime on the grid for all the jobs to be finished")
op.add_option("--job-lifetime-vN", dest="vNJOBLIFE", default=7, help="Expected lifetime on the grid for all the vN spline jobs to be finished")
