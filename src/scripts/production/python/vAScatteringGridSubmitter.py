...
op.add_option("--job-lifetime", dest="JOBLIFE", default=10, help="Expected lifetime on the grid for all the jobs to be finished, default 15h")
op.add_option("--job-lifetime-vN", dest="vNJOBLIFE", default=3, help="Expected lifetime on the grid for all the vN spline jobs to be finished, default 3h")
op.add_option("--job-lifetime-vA", dest="vAJOBLIFE", default=4, help="Expected lifetime on the grid for all the vA spline jobs to be finished, default 4h")
op.add_option("--job-lifetime-generation", dest="GENJOBLIFE", default=5, help="Expected lifetime on the grid for all the event generation jobs to be finished, default 5h")
