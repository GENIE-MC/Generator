...
def FNALShellCommands(genie_setup, group, hours = 10, memory=1, disk=20, GraceMemory=4096,GraceLifeTime=6000):
    grid_command_options = "-n -g --group "+group+" --memory="+str(memory)+"GB --disk="+str(disk)+"GB --expected-lifetime="+str(hours)+"h -f "+genie_setup 
