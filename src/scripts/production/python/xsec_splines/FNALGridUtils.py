...
def WriteMainSubmissionFile(jobs_dir, genie_topdir, group, genie_setup='/src/scripts/production/python/setup_FNALGrid.sh', in_file_name='grid_submission.xml', out_file_name='fnal_dag_submit.fnal', memory=1, disk=20, expectedlife=45, jobs=1, role="Analysis"):
