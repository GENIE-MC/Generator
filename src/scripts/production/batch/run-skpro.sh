...
# - Using standard SK statistics: 500 numu, 250 numubar, 500 nue, 250 nuebar, 250 nuesig files (2k events each, see submit-evg_sk_fhst.pl)
...
perl bulk-submit.pl --cmd "perl submit-evg_sk_fhst.pl --neutrino nuebar  --version $VRS --production $PRO --cycle $CYC" --arg "--run" --min 1 --max 250
