...
#
# Syntax:
#   shell% perl submit_xsec_calc_jobs_eA.pl <options>
#
# Options:
...
#
# Examples:
#   % perl submit_xsec_calc_jobs_eA.pl --gen-version v3.06.00 \
#                  --tune G18_10a_02_11b --spline-list ./spline_lists/hermes.list 
#
# Author:
...
{
    s/ //g;  # rm empty spaces from $_
    if($i == 0) { $probe_codes = $_; }
    else        { $probe_codes = $probe_codes . ",$_"; }
    $i++;
}
