...
PDF_t GRV98LO::AllPDFs(double x, double q2) const
{
  ...
  //double Q2    = -1*q2; ????? interface method has q2 but it is actually Q2?
  double Q2    = q2;
...
void GRV98LO::Initialize(void)
{
  ...
  string grid_file_name = 
     string(gSystem->Getenv("GENIE")) + string("/data/evgen/pdfs/GRV98lo_pdflib.LHgrid");
  ...
  LOG("GRV98LO", pINFO) << "Reading x_bj grid values";
  ...
  LOG("GRV98LO", pINFO) << "Reading Q^2 grid values.";
  ...
  LOG("GRV98LO", pINFO) << "Reading PDF values on grid points";
