...
\brief   A GENIE utility that reads-in a generated GENIE sample and generates 
         a file with loads of plots with MC truth quantities (& comparisons
         with a reference sample - if any)
         Used in validating generator changes.

         Syntax :
           gvld_sample_comp -f sample [-n events] [-r reference_sample] 
...
\example gvld_sample_comp -f /path/gntp.1.gst.root -r /path/gntp.2.gst.root
...
void PrintSyntax(void)
{
  LOG("gvldtest", pNOTICE)
    << "\n\n" << "Syntax:" << "\n"
    << "   gvld_sample_test -f sample.root [-n nev] [-r reference_sample.root]\n";
}
//_________________________________________________________________________________
bool CheckRootFilename(string filename)
{
